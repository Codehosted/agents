...
| Coverage report | `docs/verification/coverage-node-test.txt` | `npm test && npm run coverage`; 6/6 tests passing, all-files line coverage 94.41%, function coverage 93.10%, `src/recorder.js` line/function coverage 100%. |
